...
- **Rationale:** Matches the new "Premium" look and feels smoother on mobile..dockerignore
.env.example
...
<body class="bg-slate-50 flex flex-col min-h-screen">
    ...
    <header class="w-full border-b border-gray-200 py-8 px-8 sm:px-6 lg:px-8 bg-blue-600">
