    ...
    <div class="max-w-7xl mx-auto">
        ...
        <div class="mb-12">
            ...
            <div class="flex flex-wrap justify-center gap-6">
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 w-48 h-24">
                    <img src="{% static 'images/logos/realizacao/logo_secretaria_da_educacao.png' %}" alt="Logo Secretaria da Educação" class="max-h-16 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 w-48 h-24">
                    <img src="{% static 'images/logos/realizacao/logo_ure_sjc.png' %}" alt="Logo Ure SJC" class="max-h-16 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 w-48 h-24">
                    <img src="{% static 'images/logos/realizacao/logo_ciebp.png' %}" alt="Logo Centro de Inovação da Educação Básica Paulista" class="max-h-16 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 w-48 h-24">
                    <img src="{% static 'images/logos/realizacao/logo_unip.png' %}" alt="Logo Universidade Paulista " class="max-h-16 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 w-48 h-24">
                    <img src="{% static 'images/logos/realizacao/logo_jc.png' %}" alt="Logo E. E. João Cursino" class="max-h-16 max-w-[80%] object-contain">
                </div>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_marinha_do_brasil.png' %}" alt="Logo Marina do Brasil" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_dcta.png' %}" alt="Logo DCTA" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_galileo_galilei.png' %}" alt="Logo Instituto Galileo Galilei" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_parque_tecnologico_santos.png' %}" alt="Logo Parque Tecnológico Santos" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_prefeitura_santos.png' %}" alt="Logo Prefeitura Santos" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_cultivotech.png' %}" alt="Logo Cultivotech" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_nunes.png' %}" alt="Logo Nunes Projetos Incentivados" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_mf.png' %}" alt="Logo Mf Náutica" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_troglio_sports.png' %}" alt="Logo Troglio Sports" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_bse.png' %}" alt="Logo Grupo Bse" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_modirum.png' %}" alt="Logo Modirum Gespi" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_thermas_do_vale.png' %}" alt="Logo Thermas do Vale" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_robo.png' %}" alt="Logo Tesla Robótica Educacional" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_quero_aprender.png' %}" alt="Logo Canal Quero Aprender" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_va.png' %}" alt="Logo VA" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_thiago_gama.png' %}" alt="Logo Thiago Gama Especializações" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_teatro_sergio.png' %}" alt="Logo Teatro Sergio Mamberti" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_instituto_digital.png' %}" alt="Logo Instituto Digital" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_dsa.png' %}" alt="Logo DSA" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_sao_francisco.png' %}" alt="Logo Mercadinho São Francisco" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_sirvase_bem.png' %}" alt="Logo Sirva-se Bem 2" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_mg_acai.png' %}" alt="Logo Mh, Açaí e frutas congeladas" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_kamila_dias.png' %}" alt="Logo Kamila Dias" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_silvio_del_duca.png' %}" alt="Logo Silvio Del Duca Imagens" class="max-h-12 max-w-[80%] object-contain">
                </div>
                <div class="bg-white rounded-lg shadow-sm flex items-center justify-center hover:-translate-y-1 transition-transform duration-300 h-20 w-full">
                    <img src="{% static 'images/logos/apoio/logo_vincula_martech.png' %}" alt="Logo Vínculo Martech" class="max-h-12 max-w-[80%] object-contain">
                </div>
            </div>
        </div>
